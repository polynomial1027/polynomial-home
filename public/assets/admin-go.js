...
async function submitGoSettings(event) {
  ...
  const booleans = new Set(['goEnabled','goAiEnabled']), numbers = new Set(['goDefaultBoardSize','goDefaultKomi','goHandicapKomi','goMaxHandicap','goMaxUndoRequests','goDefaultMainMinutes','goMaxMainMinutes','goDefaultByoYomiSeconds','goDefaultByoYomiPeriods','goInviteExpiryMinutes','goMaxPendingInvites','goDisconnectGraceSeconds','goAiMoveTimeoutSeconds','goAiResignWinrateThreshold','goAiResignConsecutiveTurns','goScoreMaxVisits','goScoreMaxTime','goStudyMaxCount','goStudyMaxKB']), payload = {};
