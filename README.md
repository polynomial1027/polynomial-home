# Polynomial Server Home 0.1.3

完整门户包含：首页、项目、小游戏、网盘、账号系统、实时聊天，以及集课程、代码实验、随机作业评测和按账号隔离的 JupyterLab 于一体的网络学习中心。

0.1.3 在 0.1.2 完整功能基线上加入全站中英文切换。右上角语言选择会在全部页面间共享；导航、管理后台、网盘、游戏、系统提示、Python 课程、示例注释及作业说明都会切换语言。聊天内容、文件名、用户姓名、课程笔记、草稿和用户代码保持原文。网络学习继续采用“左侧目录、中间正文与作业、右侧实验区”的三栏布局，已有进度、草稿和提交记录保持兼容。
