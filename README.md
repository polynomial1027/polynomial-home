# Polynomial Server Home 0.13.0

完整门户包含：首页、项目、小游戏、网盘、账号系统、实时聊天，以及集课程、代码实验、随机作业评测和按账号隔离的 JupyterLab 于一体的网络学习中心。

0.13.0 是课程内容的大版本更新。Python 课程现包含 11 章、64 个课节和 15 道随机评测作业：新增以对象、类型、类、实例和点号语法为核心的导入章，并依次完整覆盖变量、字符串、数字、列表、循环、条件、字典、输入、函数、类、文件、异常、JSON 和自动化测试。课程中的 129 个代码示例均可独立在右侧运行；原有课程 ID、主要课节 ID和作业 ID继续保留，以兼容已有学习进度、草稿和提交记录。
