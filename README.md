# Polynomial Server Home 0.1.4

完整门户包含：首页、项目、小游戏、网盘、账号系统、实时聊天，以及集课程、代码实验、随机作业评测和按账号隔离的 JupyterLab 于一体的网络学习中心。

0.1.4 在 0.1.3 全站中英文版本上补充草稿管理：用户现在可以逐条删除自己的作业草稿，课程笔记旁标注“等待完善”，并将在后续版本继续扩展。全站聊天入口统一显示为“聊天 / Chat”。右上角语言选择仍会在全部页面间共享；聊天内容、文件名、用户姓名、课程笔记、草稿和用户代码保持原文。已有进度和提交记录保持兼容。
