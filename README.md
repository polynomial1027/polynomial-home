# Polynomial Server Home 4.0.1

完整门户包含：首页、项目、小游戏、网盘、账号系统、实时聊天，以及集课程、代码实验、随机作业评测和按账号隔离的 JupyterLab 于一体的网络学习中心。

4.0 版把 Python 实验室整合进网络学习，新增两章原创课程、15 个课节、7 个随机数据作业、内置代码实验区，以及可公开或隐藏的用时和峰值内存记录。4.0.1 修复旧容器存在但令牌文件缺失时的状态检查与自动重建。3.1 版的后台布局、网盘布局和中文文件名修复也完整保留。
