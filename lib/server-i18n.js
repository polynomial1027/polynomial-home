const systemAnnouncementsEn = {
  ...
  'python-object-memory-v015': ['0.1.5 · Python Object Memory Primer and Chat Layout Fix', 'Added a textbook-style names, references, and object identity prerequisite to Chapter 1. Restored the full-width chat composer, constrained history to its own scrollable region, and contained long content. The new-chat dialog can now always be cancelled without triggering member validation and explains direct messages versus group chats. The bilingual course contains 65 lessons and 140 independently runnable examples.']
};
