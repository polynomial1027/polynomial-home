...
const defaultSettings = {
  ...
  goAiProfiles: [
    { id: 'beginner', name: '入门', description: '快速落子，适合熟悉规则', maxVisits: 8, maxTime: 0.4 },
    { id: 'easy', name: '初级', description: '较轻量搜索', maxVisits: 40, maxTime: 1.5 },
    { id: 'medium', name: '中级', description: '平衡强度与响应速度', maxVisits: 160, maxTime: 4 },
    { id: 'strong', name: '高级', description: '更深入搜索', maxVisits: 600, maxTime: 10 }
  ],
...
module.exports = { load, save, hashPassword, verifyPassword, defaultPermissions, normalizeUser, dataDir };
