...
function topicExplanation(title) {
  return `This section explains ${title.toLowerCase()} in Python. Pay attention to object types, return values, mutation, control flow, and exceptions as applicable, then run the example to verify the behavior.`;
}
